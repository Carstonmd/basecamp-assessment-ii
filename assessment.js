...
var adjustCount = 
{
 upVote:function(number){number =+ 1;},
 downVote:function(number){number -= 1;};
}
// CODE HERE
...
// CODE HERE
var myFriends = ["Taylor","Spencer","Alec","Landon"];
...
function evensOnly() {
  // CODE HERE
  var evensArray = myNumbers.forEach(function(val,i,myNumbers)
  {
   if(myNumbers[i]%2 > 0)
   	return myNumbers[i];
  });
